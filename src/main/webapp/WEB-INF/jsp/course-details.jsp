...
<nav class="navbar navbar-light navbar-expand bg-light navigation-clean">
    <div class="container"><a class="navbar-brand" href="courseSessions">LO54</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"></button>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col text-right"><button class="btn btn-primary" type="button">S'inscrire</button></div>
                </div>
            </div>
        </div>
    </div>
